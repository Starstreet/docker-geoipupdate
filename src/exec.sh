...
! (: "${GEOIP_CONFIG_FILE?}") 2>/dev/null && {
    ...
    echo "ProductIds ${GEOIP_PRODUCT_IDS:-"GeoIP2-City GeoIP2-Connection-Type"}" >> $GEOIP_CONFIG_FILE
...
mv /tmp/GeoIP2-Connection-Type.mmdb ${GEOIP_DIRECTORY}/connection_type.mmdb
